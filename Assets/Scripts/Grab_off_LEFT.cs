...
public class Grab_off_LEFT : MonoBehaviour
{
...

    {
        ...
        if (HoldingObject)
        {
            ...
            objectInHand.GetComponent<Rigidbody>().transform.Rotate(new Vector3(RotationOffset_Cached.x + rot_X, RotationOffset_Cached.y + rot_Y, RotationOffset_Cached.z + rot_Z));
        }
    ...
    private void ReleaseObject()
    {
        ...
        //objectInHand.GetComponent<Rigidbody>().transform.localScale = new Vector3(objectInHand.GetComponent<Rigidbody>().transform.localScale.x, objectInHand.GetComponent<Rigidbody>().transform.localScale.y, objectInHand.GetComponent<Rigidbody>().transform.localScale.z * (-1));
        objectInHand = null;
